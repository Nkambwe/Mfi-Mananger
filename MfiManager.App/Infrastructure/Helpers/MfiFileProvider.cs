...
namespace MfiManager.App.Infrastructure.Helpers {
    public class MfiFileProvider : PhysicalFileProvider, IMfiFileProvider {
        protected string WebRootPath { get; }

        public MfiFileProvider(IWebHostEnvironment webHostEnvironment)
