namespace MfiManager.Middleware.Server.Defaults {
    ...
    public class CookieDefaults {
        ...
        /// </summary>
        public static string UserCookie => ".ServerUser";

        /// <summary>
        /// Gets a cookie name of the antiforgery
        /// </summary>
        public static string AntiforgeryCookie => ".ServerAntiforgery";

        /// <summary>
        /// Gets a cookie name of the session state
        /// </summary>
        public static string SessionCookie => ".ServerSession";
        /// <summary>
        /// Gets a cookie name of the System language
        /// </summary>
        public static string LanguageCookie => ".ServerLanguage";
        /// <summary>
        /// Gets a cookie name of the authentication
        /// </summary>
        public static string AuthenticationCookie => ".ServerAuthentication";
