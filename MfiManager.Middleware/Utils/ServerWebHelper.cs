...
namespace MfiManager.Middleware.Utils {
    public class ServerWebHelper(IHttpContextAccessor httpContext) : IServerWebHelper {
        ...
        public virtual bool IsPostBeingDone {
            get {
                if (_httpContext.HttpContext.Items[ServerHttpDefaults.IsPostBeingDoneRequestItem] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.HttpContext.Items[ServerHttpDefaults.IsPostBeingDoneRequestItem]);
            }

            set => _httpContext.HttpContext.Items[ServerHttpDefaults.IsPostBeingDoneRequestItem] = value;
        }
