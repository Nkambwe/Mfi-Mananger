...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlBranchRevenueCenterEntityConfiguration {

        public static void Configure(EntityTypeBuilder<BranchRevenueCenter> builder) {
            builder.ToTable("TBL_MFI_BRANCH_REVENUECENTER");
            ...
            builder.HasOne(m => m.Branch).WithMany(o => o.BranchRevenueCenters).HasForeignKey(mp => mp.BranchId);
        }
    }
}
