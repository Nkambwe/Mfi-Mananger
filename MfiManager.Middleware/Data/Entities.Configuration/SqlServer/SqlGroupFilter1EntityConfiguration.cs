...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlGroupFilter1EntityConfiguration {

        public static void Configure(EntityTypeBuilder<GroupFilter1> builder) {
            builder.ToTable("TBL_MFI_GROUP_FILTER_1");
            ...
            builder.HasMany(m => m.Groups).WithOne(o => o.GroupFilter1).HasForeignKey(mp => mp.GroupFilter1Id);
        }
    }
}
