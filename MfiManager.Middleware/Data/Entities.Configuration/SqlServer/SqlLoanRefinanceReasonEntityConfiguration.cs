...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlLoanRefinanceReasonEntityConfiguration {

        public static void Configure(EntityTypeBuilder<LoanRefinanceReason> builder) {
            builder.ToTable("TBL_MFI_LOAN_REFINANCE_REASON");
