...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlPriceGroupEntityConfiguration {

        public static void Configure(EntityTypeBuilder<PriceGroup> builder) {
            builder.ToTable("TBL_MFI_PRICE_GROUP");
            ...
            builder.HasMany(m => m.SalesOrderDefaults).WithOne(o => o.PriceGroup).HasForeignKey(mp => mp.PriceGroupId);
        }
    }
}
