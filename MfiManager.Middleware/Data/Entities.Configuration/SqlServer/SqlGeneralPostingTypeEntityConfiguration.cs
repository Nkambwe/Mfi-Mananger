...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlGeneralPostingTypeEntityConfiguration {
        public static void Configure(EntityTypeBuilder<GeneralPostingType> builder) {
             builder.ToTable("TBL_MFI_GENERAL_POSTING_TYPE");
             ...
             builder.HasMany(m => m.GeneralPostingItems).WithOne(o => o.GeneralPostingType).HasForeignKey(mp => mp.GeneralPostingTypeId);
