...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlInsuranceFeeLedgerEntityConfiguration {

        public static void Configure(EntityTypeBuilder<InsuranceFeeLedger> builder) {
            builder.ToTable("TBL_MFI_INSURANCE_FEE");
            ...
            builder.HasOne(m => m.Fee).WithMany(o => o.InsuranceFeeTransactions).HasForeignKey(mp => mp.FeeId);
            builder.HasOne(m => m.GeneralLedgerTransaction).WithMany(o => o.InsuranceFeeTransactions).HasForeignKey(mp => mp.GeneralLedgerTransactionId);
        }
     }
}
