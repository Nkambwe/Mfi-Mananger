...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlBusinessArchiveEntityConfiguration {

        public static void Configure(EntityTypeBuilder<BusinessArchive> builder) {
            builder.ToTable("TBL_MFI_ARCHIVE_BUSINESS");
            builder.HasKey(p => p.Id);
            builder.Property(p => p.Id).HasColumnName("id");
            builder.Property(p => p.BusinessId).HasColumnName("old_id");
            ...
            builder.HasOne(p => p.Branch).WithMany(e => e.BusinessArchives).HasForeignKey(e => e.BranchId);
        }
    }
}
