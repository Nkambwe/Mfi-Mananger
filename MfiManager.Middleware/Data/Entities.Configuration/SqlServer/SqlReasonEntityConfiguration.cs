...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlReasonEntityConfiguration {
        public static void Configure(EntityTypeBuilder<GeneralReason> builder) {
             ...
             builder.Property(p => p.ReasonGroupId).HasColumnName("reason_group_id");
             builder.Property(p => p.CreatedBy).HasColumnName("created_by").HasColumnType("NVARCHAR(10)").IsRequired();
             builder.Property(p => p.ModifiedOn).HasColumnName("modified_on").IsRequired(false);
             builder.Property(p => p.ModifiedBy).HasColumnName("modified_by").HasColumnType("NVARCHAR(10)").IsRequired(false);
             builder.HasOne(m => m.ReasonGroup).WithMany(o => o.Reasons).HasForeignKey(mp => mp.ReasonGroupId);
