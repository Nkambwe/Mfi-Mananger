...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlCardLedgerEntityConfiguration {
        ...
        public static void Configure(EntityTypeBuilder<CardLedger> builder) {
            ...
            builder.Property(p => p.GeneralLedgerId).HasColumnName("general_ledegr_id");
            ...
            builder.HasOne(u => u.GeneralLedger).WithMany(bc => bc.CardTransactions).HasForeignKey(bc => bc.GeneralLedgerId);
        }
    }
}
