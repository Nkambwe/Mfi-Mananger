...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlModifiedLedgerEntityConfiguration {

        public static void Configure(EntityTypeBuilder<ModifiedLedger> builder) {
            builder.ToTable("TBL_MFI_MOD_GENERAL_LEDGER");
            ...
            builder.HasOne(m => m.Transaction).WithMany(o => o.ModifiedLedgerTransactions).HasForeignKey(mp => mp.TransactionId);
            builder.HasOne(p => p.Reason).WithMany(e => e.ModifiedTransactions).HasForeignKey(e => e.ReasonId);
        }
    }
