...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlRegistrationFeeLedgerEntityConfiguration {

        public static void Configure(EntityTypeBuilder<RegistrationFeeLedger> builder) {
            builder.ToTable("TBL_MFI_REGISTRATION_FEE");
            ...
            builder.HasOne(m => m.Fee).WithMany(o => o.RegistrationFeeTransactions).HasForeignKey(mp => mp.FeeId);
            builder.HasOne(m => m.GeneralLedgerTransaction).WithMany(o => o.RegistrationFeeTransactions).HasForeignKey(mp => mp.GeneralLedgerTransactionId);
        }
    }
}
