...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlSalesOrderClassificationEntityConfiguration {

        public static void Configure(EntityTypeBuilder<SalesOrderClassification> builder) {
            builder.ToTable("TBL_MFI_SALES_ORDER_CLASSIFICATION");
            ...
            builder.HasMany(m => m.SalesOrderDefaults).WithOne(o => o.OrderClassification).HasForeignKey(mp => mp.OrderClassificationId);
        }
    }
}
