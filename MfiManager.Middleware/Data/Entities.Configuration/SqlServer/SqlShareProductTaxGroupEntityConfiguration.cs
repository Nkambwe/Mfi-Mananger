...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlShareProductTaxGroupEntityConfiguration {
        
        public static void Configure(EntityTypeBuilder<ShareProductTaxGroup> builder) {
            builder.ToTable("TBL_MFI_SHPRODUCT_TAX_GROUP");
            ...
            builder.HasOne(bc => bc.TaxGroup).WithMany(g => g.ShareProducts).HasForeignKey(bc => bc.TaxGroupId).OnDelete(DeleteBehavior.Cascade);
        }
