...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlInsuranceProductEntityConfiguration {
        public static void Configure(EntityTypeBuilder<InsuranceProduct> builder) {
            ...
            builder.HasMany(m => m.ChargedItems).WithOne(o => o.InsuranceProduct).HasForeignKey(mp => mp.InsuranceProductId);
            builder.HasMany(m => m.TaxableItems).WithOne(o => o.InsuranceProduct).HasForeignKey(mp => mp.InsuranceProductId);
            builder.HasMany(m => m.ProductParams).WithOne(o => o.InsuranceProduct).HasForeignKey(mp => mp.InsuranceProductId);
