...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlTimedepositProductParamEntityConfiguration {

        public static void Configure(EntityTypeBuilder<TimedepositProductParam> builder) {
            builder.ToTable("TBL_MFI_PRODUCT_TIMEDEPOSIT_PARAM");
            ...
            builder.HasOne(m => m.TimedepositProduct).WithMany(o => o.ProductParams).HasForeignKey(mp => mp.TimedepositProductId);
        }
    }
}
