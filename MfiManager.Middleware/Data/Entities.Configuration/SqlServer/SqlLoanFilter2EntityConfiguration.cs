...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlLoanFilter2EntityConfiguration {
        
        public static void Configure(EntityTypeBuilder<LoanFilter2> builder) {
            builder.ToTable("TBL_MFI_LOAN_CUSTOM_FILTER_2");
