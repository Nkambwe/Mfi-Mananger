...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlSavingFeeLedgerEntityConfiguration {

        public static void Configure(EntityTypeBuilder<SavingFeeLedger> builder) {
            builder.ToTable("TBL_MFI_SAVING_FEE");
            ...
            builder.HasOne(m => m.Fee).WithMany(o => o.SavingFeeTransactions).HasForeignKey(mp => mp.FeeId);
            builder.HasOne(m => m.GeneralLedgerTransaction).WithMany(o => o.SavingnFeeTransactions).HasForeignKey(mp => mp.GeneralLedgerTransactionId);
        }
    }
}
