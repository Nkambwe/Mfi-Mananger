...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlGroupFilter2EntityConfiguration {

        public static void Configure(EntityTypeBuilder<GroupFilter2> builder) {
            builder.ToTable("TBL_MFI_GROUP_FILTER_2");
            ...
            builder.HasMany(m => m.Groups).WithOne(o => o.GroupFilter2).HasForeignKey(mp => mp.GroupFilter2Id);
        }
    }
}
