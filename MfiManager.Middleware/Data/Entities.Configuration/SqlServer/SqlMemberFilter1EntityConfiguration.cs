...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlMemberFilter1EntityConfiguration {

        public static void Configure(EntityTypeBuilder<MemberFilter1> builder) {
            builder.ToTable("TBL_MFI_MEMBER_FILTER_1");
            ...
            builder.HasMany(m => m.Members).WithOne(o => o.MemberFilter1).HasForeignKey(mp => mp.MemberFilter1Id);
        }
    }
}
