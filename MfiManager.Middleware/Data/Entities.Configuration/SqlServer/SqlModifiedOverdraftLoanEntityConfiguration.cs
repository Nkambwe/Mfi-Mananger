...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlModifiedOverdraftLoanEntityConfiguration {

        public static void Configure(EntityTypeBuilder<ModifiedOverdraftLoan> builder) {
            builder.ToTable("TBL_MFI_MOD_OVERDRAFT_LOAN");
            ...
            builder.HasOne(p => p.Overdraft).WithMany(e => e.Modifications).HasForeignKey(e => e.OverdraftId);
        }
    }
