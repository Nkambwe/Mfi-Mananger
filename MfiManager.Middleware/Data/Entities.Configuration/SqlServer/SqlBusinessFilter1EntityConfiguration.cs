...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlBusinessFilter1EntityConfiguration {

        public static void Configure(EntityTypeBuilder<BusinessFilter1> builder) {
            builder.ToTable("TBL_MFI_BUSINESS_FILTER_1");
            ...
            builder.HasMany(m => m.Businesses).WithOne(o => o.BusinessFilter1).HasForeignKey(mp => mp.BusinessFilter1Id);
        }
    }
}
