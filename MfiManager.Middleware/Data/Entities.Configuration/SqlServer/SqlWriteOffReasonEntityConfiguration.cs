...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlWriteOffReasonEntityConfiguration {
        public static void Configure(EntityTypeBuilder<WriteOffReason> builder) {
            builder.ToTable("TBL_MFI_LOAN_WRITEOFF_REASON");
