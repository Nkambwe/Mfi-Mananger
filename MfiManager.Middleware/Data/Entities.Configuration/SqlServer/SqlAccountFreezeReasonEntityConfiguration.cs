...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlAccountFreezeReasonEntityConfiguration {
        public static void Configure(EntityTypeBuilder<AccountFreezeReason> builder) {
            builder.ToTable("TBL_MFI_SAVING_ACCOUNT_FREEZE_REASON");
            ...
            builder.HasMany(bc => bc.FrozenAccounts).WithOne(p => p.Reason).HasForeignKey(bc => bc.ReasonId).OnDelete(DeleteBehavior.Cascade);
        }
    }
}
