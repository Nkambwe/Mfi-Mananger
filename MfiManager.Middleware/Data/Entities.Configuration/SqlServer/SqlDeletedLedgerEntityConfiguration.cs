...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlDeletedLedgerEntityConfiguration {
        public static void Configure(EntityTypeBuilder<DeletedLedger> builder) {
            builder.ToTable("TBL_MFI_DELETED_LEDGER");
