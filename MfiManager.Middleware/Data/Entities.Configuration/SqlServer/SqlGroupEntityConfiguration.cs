...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    ...
    public class SqlGroupEntityConfiguration {

        public static void Configure(EntityTypeBuilder<Group> builder) {
            builder.ToTable("TBL_MFI_GROUP");
            ...
            builder.Property(p => p.RegisteredName).HasColumnName("registered_name").HasColumnType("NVARCHAR(MAX)").IsRequired();
            ...
            builder.Property(p => p.GroupFilter1Id).HasColumnName("group_filter_1_id").IsRequired(false);
            builder.Property(p => p.GroupFilter2Id).HasColumnName("group_filter_2_id").IsRequired(false);
            ...
            builder.HasOne(p => p.Branch).WithMany(e => e.Groups).HasForeignKey(e => e.BranchId);
            builder.HasOne(p => p.ClientFilter1).WithMany(e => e.Groups).HasForeignKey(e => e.Filter1Id);
            builder.HasOne(p => p.ClientFilter2).WithMany(e => e.Groups).HasForeignKey(e => e.Filter2Id);
            builder.HasOne(p => p.ClientFilter3).WithMany(e => e.Groups).HasForeignKey(e => e.Filter3Id);
            builder.HasOne(p => p.GroupFilter1).WithMany(e => e.Groups).HasForeignKey(e => e.GroupFilter1Id);
            builder.HasOne(p => p.GroupFilter2).WithMany(e => e.Groups).HasForeignKey(e => e.GroupFilter2Id);
            builder.HasMany(p => p.Members).WithOne(e => e.Group).HasForeignKey(e => e.GroupId);
            builder.HasMany(p => p.Clusters).WithOne(e => e.Group).HasForeignKey(e => e.GroupId);
            builder.HasMany(p => p.CustomerApprovals).WithOne(e => e.Group).HasForeignKey(e => e.GroupId);
            builder.HasMany(p => p.Meetings).WithOne(e => e.Group).HasForeignKey(e => e.GroupId);
            builder.HasMany(p => p.TimedepositAccounts).WithOne(e => e.GroupClient).HasForeignKey(e => e.GroupId);
            builder.HasMany(p => p.Rejects).WithOne(e => e.Group).HasForeignKey(e => e.GroupId);
        }
    }
}
