...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlApprovedAmountEntityConfiguration {
        
        public static void Configure(EntityTypeBuilder<ApprovedAmount> builder) {
            ...
            builder.HasOne(bc => bc.Loan).WithMany(p => p.ApprovedAmounts).HasForeignKey(bc => bc.LoanId).OnDelete(DeleteBehavior.Cascade);
        }
    }
}
