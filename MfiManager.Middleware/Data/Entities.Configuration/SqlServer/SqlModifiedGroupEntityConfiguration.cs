...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlModifiedGroupEntityConfiguration {

        public static void Configure(EntityTypeBuilder<ModifiedGroup> builder) {
            builder.ToTable("TBL_MFI_MOD_GROUP");
            ...
            builder.HasOne(p => p.Reason).WithMany(e => e.ModifiedGroups).HasForeignKey(e => e.ReasonId);
            builder.HasOne(p => p.Group).WithMany(e => e.ModifiedGroups).HasForeignKey(e => e.GroupId);
        }
    }
}
