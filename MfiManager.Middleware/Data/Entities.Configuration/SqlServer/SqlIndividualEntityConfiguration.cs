...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    ...
    public class SqlIndividualEntityConfiguration {

        public static void Configure(EntityTypeBuilder<Individual> builder) {
            ...
            builder.HasOne(p => p.Branch).WithMany(e => e.Individuals).HasForeignKey(e => e.BranchId);
            builder.HasOne(p => p.Filter1).WithMany(e => e.Individuals).HasForeignKey(e => e.Filter1Id);
            builder.HasOne(p => p.Filter2).WithMany(e => e.Individuals).HasForeignKey(e => e.Filter2Id);
            builder.HasOne(p => p.Filter3).WithMany(e => e.Individuals).HasForeignKey(e => e.Filter3Id);
            builder.HasOne(p => p.Title).WithMany(e => e.Individuals).HasForeignKey(e => e.TitleId);
            builder.HasOne(p => p.Village).WithMany(e => e.Individuals).HasForeignKey(e => e.VillageId);
            builder.HasOne(p => p.Profession).WithMany(e => e.Individuals).HasForeignKey(e => e.ProfessionId);
