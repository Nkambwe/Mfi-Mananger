...
namespace MfiManager.Middleware.Data.Entities.Configuration.SqlServer {
    public class SqlModifiedMemberEntityConfiguration {

        public static void Configure(EntityTypeBuilder<ModifiedMember> builder) {
            builder.ToTable("TBL_MFI_MOD_MEMBER");
            ...
            builder.Property(p => p.MemberFilter1).HasColumnName("mem_filter1_id").IsRequired(false);
            builder.Property(p => p.MemberFilter2).HasColumnName("mem_filter2_id").IsRequired(false);
            ...
            builder.HasOne(p => p.Reason).WithMany(e => e.ModifiedMembers).HasForeignKey(e => e.ReasonId);
            builder.HasOne(p => p.Member).WithMany(e => e.ModifiedMembers).HasForeignKey(e => e.MemberId);
        }
    }
}
