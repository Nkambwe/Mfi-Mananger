...
namespace MfiManager.Middleware.Data.Entities.Operations.Loans {
    public class IndividualLoan: LoanBase {
        ...
        public virtual ICollection<IndividualLoanCollateral> Collaterals { get; set; } = [];
        public virtual ICollection<LoanDue> LoanDues { get; set; } = [];
        public virtual ICollection<IndividualLoanGuarantor> Guarantors { get; set; } = [];
        ...
        /// </summary>
        /// <param name="otherLoan"/>Object to compare to this  <see cref="IndividualLoan"/>
        /// <returns>
        /// True if object is the same as this <see cref="IndividualLoan"/>, false otherwise.
        /// </returns>
        public override bool Equals(object otherLoan) {

            if (otherLoan == null || otherLoan.GetType() != typeof(IndividualLoan)) return false;

            if (ReferenceEquals(this, otherLoan)) return true;

            var loan = otherLoan as IndividualLoan;
            return loan != null && loan.LoanNumber.Trim().Equals(LoanNumber.Trim(), StringComparison.CurrentCultureIgnoreCase);
        }

        /// <summary>
        /// Compares two instances of <see cref="IndividualLoan"/> objects for equality.
        /// </summary>
        /// <param name="thisLoan">The First <see cref="IndividualLoan"/> instance to compare.</param>
        /// <param name="thatLoan">The second <see cref="IndividualLoan"/> instance to compare.</param>
        /// <returns>
        /// True when the loans are the same, false otherwise.
        /// </returns>
        public static bool operator ==(IndividualLoan thisLoan, IndividualLoan thatLoan)
            => thatLoan?.Equals(thisLoan) ?? Equals(thisLoan, null);

        /// <summary>
        /// Compares two instances of <see cref="IndividualLoan"/> objects for inequality.
        /// </summary>
        /// <param name="thisLoan">The First <see cref="IndividualLoan"/> instance to compare.</param>
        /// <param name="thatLoan">The second <see cref="IndividualLoan"/> instance to compare.</param>
        /// <returns>
