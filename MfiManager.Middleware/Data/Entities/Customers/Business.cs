...
namespace MfiManager.Middleware.Data.Entities.Customers {
    public class Business : IClient {
        ...
        public override string ToString() => $"{(string.IsNullOrEmpty(Code) ? "000000" : Code.Trim())}-{(string.IsNullOrEmpty(LegalName) ? "Business" : LegalName.Trim())}";
