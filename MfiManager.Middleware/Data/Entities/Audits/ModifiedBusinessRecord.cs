...
namespace MfiManager.Middleware.Data.Entities.Audits {
    ...
    /// </summary>
    public class ModifiedBusinessRecord : BaseEntity {
        ...
        public long? CustomeProperty1Id { get; set; }
        public long? CustomeProperty2Id { get; set; }
        ...
        public string ModifiedLegalName { get; set; }
