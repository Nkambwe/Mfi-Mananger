...
namespace MfiManager.Middleware.Data.Entities.Audits {
    /// <summary>
    /// Modified group record
    /// </summary>
    public class ModifiedGroupRecord : BaseEntity {
        ...
        public long? FirstGroupCustomId { get; set; }
        public long? SecondGroupCustomId { get; set; }
        ...
        public string ModfiedGroupName { get; set; }
        ...
        public long? ModifiedFirstGroupCustomId { get; set; }
        public long? ModifiedSecondGroupCustomId { get; set; }
