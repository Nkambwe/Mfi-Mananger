...
namespace MfiManager.Middleware.Data.Entities.System.Configurations.Parameters {
    public class UserSettings : IConfigurationParameter {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether 'Campus' is enabled
        /// </summary>
        public bool CampusEnabled { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether 'Campus' is required
        /// </summary>
        public bool CampusRequired { get; set; }
