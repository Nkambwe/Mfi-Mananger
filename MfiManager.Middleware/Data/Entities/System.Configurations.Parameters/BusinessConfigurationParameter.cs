namespace MfiManager.Middleware.Data.Entities.System.Configurations.Parameters {
    public class BusinessConfigurationParameter :CustomerConfigurationParameter, IConfigurationParameter  { 
        ...
        /// </summary>
        public bool RequireBusinessFilter1 { get; set; }
        ...
        /// </summary>
        public bool RequireBusinessFilter2 { get; set; }
        /// <summary>
        ...
        public string BusinessClientMailMerge { get; set; }
